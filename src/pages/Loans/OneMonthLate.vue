      ...
      <div class="flex justify-between items-start">
        <div>
          <div class="flex items-center space-x-2">
            <h1 class="text-2xl font-bold text-gray-900">1 Month Late Loans</h1>
            <a href="#" class="text-sm text-primary-600 hover:text-primary-800">Help</a>
          </div>
          <p class="text-gray-600 mt-2">
            This shows loans overdue by 30 days or more. This is calculated from the loan schedule
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
      ...
      <div class="px-6 py-4 border-b border-gray-200">
        <div class="flex items-center justify-between">
          <h3 class="text-lg font-medium text-gray-900">1 Month Late Loans</h3>
          <div class="flex items-center space-x-2">
...
// Mock data for 1 month late loans (currently empty as shown in UI)
const mockLoans = ref([]);
...
const searchLoans = async () => {
  ...
  try {
    ...
    console.log("Searching 1 month late loans with filters:", filters.value);
  } catch (error) {
