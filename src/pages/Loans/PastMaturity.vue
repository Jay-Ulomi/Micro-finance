      ...
      <div class="flex justify-between items-start">
        <div>
          <div class="flex items-center space-x-2">
            <h1 class="text-2xl font-bold text-gray-900">Past Maturity Date</h1>
            <a href="#" class="text-sm text-primary-600 hover:text-primary-800">Help</a>
          </div>
          <p class="text-gray-600 mt-2">
            Loans that are past the maturity date and have not been fully paid.
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
      ...
      <div class="px-6 py-4 border-b border-gray-200">
        <div class="flex items-center justify-between">
          <h3 class="text-lg font-medium text-gray-900">Past Maturity Date</h3>
          <div class="flex items-center space-x-2">
            ...
            <tr v-else-if="filteredLoans.length === 0">
              <td colspan="11" class="px-6 py-12 text-center">
                ...
                <h3 class="mt-2 text-sm font-medium text-gray-900">
                  No loans past maturity date found
                </h3>
...
// Mock data for loans past maturity date
const mockLoans = ref([
  {
    id: "1",
...
const filteredLoans = computed(() => {
  ...
  loans = loans.filter((loan) => loan.daysPast >= filters.value.overdueBy);
...
const searchLoans = async () => {
  ...
  try {
    ...
    console.log("Searching loans past maturity with filters:", filters.value);
  } catch (error) {
