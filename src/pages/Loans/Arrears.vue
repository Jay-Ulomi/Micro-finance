  ...
  <div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
      <div class="flex justify-between items-start">
        <div>
          <h1 class="text-2xl font-bold text-gray-900">Loans in Arrears</h1>
          <p class="text-gray-600 mt-2">
            Loans that are overdue but have not missed a repayment. Once a loan becomes overdue, it
            will be marked as Missed Repayment status. If a part-payment has been received for last
            collection date and loan is overdue and not expired, it will be converted into Arrears
            status.
          </p>
        </div>
      </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
      ...
      <div class="px-6 py-4 border-b border-gray-200">
        <div class="flex items-center justify-between">
          <h3 class="text-lg font-medium text-gray-900">Loans in Arrears</h3>
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            ...
            <tr v-else-if="filteredLoans.length === 0">
              <td colspan="10" class="px-6 py-12 text-center">
                ...
                <h3 class="mt-2 text-sm font-medium text-gray-900">No loans in arrears found</h3>
...
// Mock data for loans in arrears
const mockLoans = ref([
  {
    id: "1",
...
const filteredLoans = computed(() => {
  ...
  loans = loans.filter((loan) => loan.pastDue > 0);
...
const searchLoans = async () => {
  ...
  try {
    ...
    console.log("Searching loans in arrears with filters:", filters.value);
  } catch (error) {
