  ...
  routes: [
    {
      ...
      children: [
        ...
        },
        {
          ...
          meta: { title: "CRM Leads" },
        },
        {
          path: "crm/opportunities",
          name: "crm-opportunities",
          component: () => import("@/pages/CRM/Opportunities.vue"),
          meta: { title: "CRM Opportunities" },
        },
        {
          path: "crm/activities",
          name: "crm-activities",
          component: () => import("@/pages/CRM/Activities.vue"),
          meta: { title: "CRM Activities" },
        },
        {
          path: "crm/tasks",
          name: "crm-tasks",
          component: () => import("@/pages/CRM/Tasks.vue"),
          meta: { title: "CRM Tasks" },
        },
        {
          path: "crm/calendar",
          name: "crm-calendar",
          component: () => import("@/pages/CRM/Calendar.vue"),
          meta: { title: "CRM Calendar" },
        },
        {
          path: "crm/communications",
          name: "crm-communications",
          component: () => import("@/pages/CRM/Communications.vue"),
          meta: { title: "CRM Communications" },
        },
        // CRM Add Routes
        {
          path: "crm/contacts/add",
          name: "crm-contacts-add",
          component: () => import("@/pages/CRM/AddContact.vue"),
          meta: { title: "Add Contact" },
        },
        {
          path: "crm/leads/add",
          name: "crm-leads-add",
          component: () => import("@/pages/CRM/AddLead.vue"),
          meta: { title: "Add Lead" },
        },
        {
          path: "crm/opportunities/add",
          name: "crm-opportunities-add",
          component: () => import("@/pages/CRM/AddOpportunity.vue"),
          meta: { title: "Add Opportunity" },
        },
        {
          path: "crm/activities/add",
          name: "crm-activities-add",
          component: () => import("@/pages/CRM/AddActivity.vue"),
          meta: { title: "Add Activity" },
        },
        {
          path: "crm/tasks/add",
          name: "crm-tasks-add",
          component: () => import("@/pages/CRM/AddTask.vue"),
          meta: { title: "Add Task" },
        },
        {
          path: "crm/communications/add",
          name: "crm-communications-add",
          component: () => import("@/pages/CRM/AddCommunication.vue"),
          meta: { title: "Add Communication" },
        },
        {
          path: "crm/leads/:id/convert",
          name: "crm-leads-convert",
          component: () => import("@/pages/CRM/ConvertLead.vue"),
          meta: { title: "Convert Lead to Opportunity" },
        },
        ...
        },
        {
          ...
          name: "reports-borrowers",
          component: () => import("@/pages/Reports/Borrowers.vue"),
          meta: { title: "Borrowers Report" },
        },
        {
          path: "reports/loans",
          name: "reports-loans",
          component: () => import("@/pages/Reports/Loans.vue"),
          meta: { title: "Loan Report" },
        },
        {
          path: "reports/loan-arrears",
          name: "reports-loan-arrears",
          component: () => import("@/pages/Reports/LoanArrears.vue"),
          meta: { title: "Loan Arrears Aging Report" },
        },
        {
          path: "reports/collections",
          name: "reports-collections",
          component: () => import("@/pages/Reports/Collections.vue"),
          meta: { title: "Collections Report" },
        },
        {
          path: "reports/collector",
        ...
        },
        {
          ...
          name: "reports-pro-rata",
          component: () => import("@/pages/Reports/ProRataCollections.vue"),
          meta: { title: "Pro-Rata Collections Monthly" },
        },
        {
          path: "reports/disbursement",
          name: "reports-disbursement",
          component: () => import("@/pages/Reports/Disbursement.vue"),
          meta: { title: "Disbursement Report" },
        },
        {
          path: "reports/fees",
          name: "reports-fees",
          component: () => import("@/pages/Reports/Fees.vue"),
          meta: { title: "Fees Report" },
        },
        {
          path: "reports/loan-officer",
          name: "reports-loan-officer",
          component: () => import("@/pages/Reports/LoanOfficer.vue"),
          meta: { title: "Loan Officer Report" },
        },
        {
          path: "reports/loan-products",
          name: "reports-loan-products",
          component: () => import("@/pages/Reports/LoanProducts.vue"),
          meta: { title: "Loan Products Report" },
        },
        {
          path: "reports/mfrs-ratios",
          name: "reports-mfrs-ratios",
          component: () => import("@/pages/Reports/MFRSRatios.vue"),
          meta: { title: "MFRS Ratios" },
        },
        {
          path: "reports/daily",
          name: "reports-daily",
        ...
        },
        {
          ...
          component: () => import("@/pages/Reports/Outstanding.vue"),
          meta: { title: "Outstanding Report" },
        },
        {
          path: "reports/par",
          name: "reports-par",
          component: () => import("@/pages/Reports/PortfolioAtRisk.vue"),
          meta: { title: "Portfolio At Risk (PAR)" },
        },
        {
        ...
        },
        {
          ...
          component: () => import("@/pages/Accounting/CashFlow.vue"),
          meta: { title: "Cash Flow Statement" },
        },
        {
          path: "accounting/cash-flow-monthly",
          name: "accounting-cash-flow-monthly",
          component: () => import("@/pages/Accounting/CashFlowMonthly.vue"),
          meta: { title: "Cash Flow Monthly" },
        },
        {
          path: "accounting/branch-equity",
          name: "accounting-branch-equity",
          component: () => import("@/pages/Accounting/BranchEquity.vue"),
          meta: { title: "Branch Equity" },
        },
        {
          path: "accounting/branch-equity/create",
          name: "accounting-add-branch-capital",
          component: () => import("@/pages/Accounting/AddBranchCapital.vue"),
          meta: { title: "Add Branch Capital" },
        },
        {
          path: "accounting/inter-bank-transfers",
          name: "accounting-inter-bank-transfers",
          component: () => import("@/pages/Accounting/InterBankTransfers.vue"),
          meta: { title: "Inter Bank Transfers" },
        },
        {
          path: "accounting/inter-bank-transfers/create",
          name: "accounting-add-inter-bank-transfer",
          component: () => import("@/pages/Accounting/AddInterBankTransfer.vue"),
          meta: { title: "Add Inter Bank Transfer" },
        },
        {
        ...
        },
        {
          ...
          name: "accounting-add-chart-of-account",
          component: () => import("@/pages/Accounting/AddChartOfAccount.vue"),
          meta: { title: "Add Chart of Account" },
        },
        {
          path: "accounting/manual-journal",
          name: "accounting-view-manual-journal",
          component: () => import("@/pages/Accounting/ViewManualJournal.vue"),
          meta: { title: "View Manual Journal" },
        },
        {
          path: "accounting/manual-journal/create",
          name: "accounting-add-manual-journal",
          component: () => import("@/pages/Accounting/AddManualJournal.vue"),
          meta: { title: "Add Manual Journal" },
        },
        // Settings
        {
          path: "settings",
        ...
        },
        {
          ...
          name: "settings-add-tax",
          component: () => import("@/pages/Settings/AddTax.vue"),
          meta: { title: "Add Tax" },
        },
      ],
    },
